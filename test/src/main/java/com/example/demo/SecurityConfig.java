...
// 이파일은 시큐리티의 설정을 담당할 파일.(스프링의 환경설정 파일 / 누렁이집(누렁이의 경비초소))
...
public class SecurityConfig {
	...
	// 스프링 시큐리티는 오늘 하는것말고도 더 세부적으로 분할하고 자세하게
	// 설정하는것 또한 가능.
	
	// http.authorizeHttpRequests() : http 요청에 대한 인증및 권한부여 규칙 설정 메서드.
